...
public class VistaBuscarProveedor extends JFrame implements IGUI{
	...
	public VistaBuscarProveedor() {
		...
		ok.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Controlador.getInstancia().accion(Eventos.BUSCAR_PROVEEDOR, tProveedor); 
				VistaBuscarProveedor.this.dispose(); 
		}
		});
	...
	public void actualizar(int evento, Object datos) {
		if(evento == Eventos.RES_BUSCAR_PROVEEDOR_OK) {
			this.dispose(); 
			JOptionPane.showMessageDialog(this, "Nombre: "+((TProveedor) datos).getNombre()+"\n"+
					"Telefono: "+((TProveedor) datos).getTelefono()+"\n" +"Correo: "+((TProveedor) datos).getCorreo()+"\n");
		}
