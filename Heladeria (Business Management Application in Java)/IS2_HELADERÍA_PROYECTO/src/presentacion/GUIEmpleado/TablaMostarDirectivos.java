...
public class TablaMostarDirectivos extends AbstractTableModel{
	
	private List<String> columnNames;
	private List<TransferEmpleado> empleados;
	
	public TablaMostarDirectivos(List<TransferEmpleado> empleados) {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		case 4: return empleado.getCargo();
		default: return null;
		}
	}
