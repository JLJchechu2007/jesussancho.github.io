...
public class TablaMostarVendedores extends AbstractTableModel{
	
	private List<String> columnNames;
	private List<TransferEmpleado> empleados;
	
	public TablaMostarVendedores(List<TransferEmpleado> empleados) {
		...
		columnNames.add("Numero de ventas");
	}
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		case 1: return empleado.getApellido();
		case 2: return empleado.getDNI();
		case 3: return empleado.getSueldo();
		case 4: return empleado.getVentas();
		default: return null;
		}
	}
